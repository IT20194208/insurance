...
<div class="sidebar2">
		...
		<h1 class="adminTopic">Manage Suraksha Policy</h1>
    ...
    <th>Delete</th>
       ...
       while ($row=mysqli_fetch_array($sqldata,MYSQLI_ASSOC))
       {
        ...
        <button style="border:2px solid yellow; border-radius:7px; background-color:red;color:white;">
          <a href="updatePolicy.php?id=<?php echo $row['id'];?>">
        ...
        <button style = "border:2px solid yellow; border-radius:7px; background-color:red;color:white;" >
          <a href="deletePolicy.php?id=<?php echo $row['id'];?>">
...
<br>
                       ...
                       <a href="Addpolicy.php">     <button class="btnPolicy">Add Policy</button></a>
