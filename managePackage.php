...
<div class="sidebar2">
    ...
    <h1 class="adminTopic">Manage Suraksha Package</h1>
    ...
    <th>Delete</th>
       ...
       while ($row=mysqli_fetch_array($sqldata,MYSQLI_ASSOC))
       {
        ...
        <button style="border:2px solid yellow; border-radius:7px; background-color:red;color:white;">
          <a href="updatePackage.php?id=<?php echo $row['id'];?>">
        ...
        <button style = "border:2px solid yellow; border-radius:7px; background-color:red;color:white;" >
          <a href="deletePackage.php?id=<?php echo $row['id'];?>">
...
<br>
                       ...
                       <a href="AddPackage.php">     <button class="btnPolicy">Add Package</button></a>
